#ifndef SIMILAR2LOGO_AGENTPOSITIONUPDATE_H
#define SIMILAR2LOGO_AGENTPOSITIONUPDATE_H
...
/**
 * Models an influence that aims at updating the positions of turtles in the
 * Logo environment. Matches the Java implementation exactly.
 *
 * @author Gildas Morvan
 * @author Yoann Kubera
 */
class AgentPositionUpdate : public microkernel::influences::RegularInfluence {
public:
  /**
   ...
   */
  static constexpr const char *CATEGORY = "agent position update";
...
public:
   ...
   */
  AgentPositionUpdate(const microkernel::SimulationTimeStamp &timeLowerBound,
   ...
   * @param timeUpperBound The upper bound of the transitory period
   */
  AgentPositionUpdate(const microkernel::LevelIdentifier &levelIdentifier,
...
#endif // SIMILAR2LOGO_AGENTPOSITIONUPDATE_H
