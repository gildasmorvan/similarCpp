#ifndef SIMILAR2LOGO_REMOVEMARK_H
#define SIMILAR2LOGO_REMOVEMARK_H
 ...
 * @author Yoann Kubera
 */
class RemoveMark : public microkernel::influences::RegularInfluence {
public:
  /**
   ...
   */
  static constexpr const char *CATEGORY = "remove mark";
...
public:
   ...
   */
  RemoveMark(const microkernel::SimulationTimeStamp &timeLowerBound,
   ...
   * @param mark The mark to remove
   */
  RemoveMark(const microkernel::LevelIdentifier &levelIdentifier,
...
#endif // SIMILAR2LOGO_REMOVEMARK_H
