#ifndef SIMILAR2LOGO_CHANGEPOSITION_H
#define SIMILAR2LOGO_CHANGEPOSITION_H
 ...
 * @author Yoann Kubera
 */
class ChangePosition : public microkernel::influences::RegularInfluence {
public:
  /**
   ...
   */
  static constexpr const char *CATEGORY = "change position";
...
#endif // SIMILAR2LOGO_CHANGEPOSITION_H
